      ...
      {(widgets.revenueTrend || widgets.topPerformer) && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          {widgets.topPerformer && (
            <div className={`${widgets.revenueTrend ? '' : 'md:col-span-3'} cyber-border p-8 card-shadow bg-[#0F172A] text-white flex flex-col`}>
              ...
              <button onClick={() => onNavigate('inventory')} className="mt-8 w-full h-14 bg-white text-[#0F172A] font-black rounded-2xl flex items-center justify-center gap-2 hover:bg-[#2DD4BF] transition-all">
